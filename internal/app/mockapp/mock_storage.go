//lint:file-ignore ST1000,QF1010 Ignore generated mocks
...
func (_m *Storage) Stats(ctx context.Context) (*model.StatsResponse, error) {
	ret := _m.Called(ctx)
...
func (_c *Storage_Stats_Call) Return(_a0 *model.StatsResponse, _a1 error) *Storage_Stats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Storage_Stats_Call) RunAndReturn(run func(context.Context) (*model.StatsResponse, error)) *Storage_Stats_Call {
	_c.Call.Return(run)
	return _c
}

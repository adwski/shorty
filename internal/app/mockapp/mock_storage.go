...
import (
	...
	model "github.com/adwski/shorty/internal/model"
...
func (_m *Storage) DeleteUserURLs(ctx context.Context, urls []model.URL) (int64, error) {
...
func (_c *Storage_DeleteUserURLs_Call) Run(run func(ctx context.Context, urls []model.URL)) *Storage_DeleteUserURLs_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Storage_DeleteUserURLs_Call) RunAndReturn(run func(context.Context, []model.URL) (int64, error)) *Storage_DeleteUserURLs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Storage) ListUserURLs(ctx context.Context, userid string) ([]*model.URL, error) {
...
func (_c *Storage_ListUserURLs_Call) Return(_a0 []*model.URL, _a1 error) *Storage_ListUserURLs_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Storage_ListUserURLs_Call) RunAndReturn(run func(context.Context, string) ([]*model.URL, error)) *Storage_ListUserURLs_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Storage) Stats(ctx context.Context) (*model.Stats, error) {
	ret := _m.Called(ctx)
...
func (_c *Storage_Stats_Call) Return(_a0 *model.Stats, _a1 error) *Storage_Stats_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Storage_Stats_Call) RunAndReturn(run func(context.Context) (*model.Stats, error)) *Storage_Stats_Call {
	_c.Call.Return(run)
	return _c
}

// Store provides a mock function with given fields: ctx, url, overwrite
func (_m *Storage) Store(ctx context.Context, url *model.URL, overwrite bool) (string, error) {
	...
	var r0 string
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, *model.URL, bool) (string, error)); ok {
		return rf(ctx, url, overwrite)
	}
	if rf, ok := ret.Get(0).(func(context.Context, *model.URL, bool) string); ok {
		r0 = rf(ctx, url, overwrite)
	} else {
		r0 = ret.Get(0).(string)
	}

	if rf, ok := ret.Get(1).(func(context.Context, *model.URL, bool) error); ok {
...
func (_c *Storage_Store_Call) Run(run func(ctx context.Context, url *model.URL, overwrite bool)) *Storage_Store_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*model.URL), args[2].(bool))
	})
	return _c
}
...
func (_c *Storage_Store_Call) RunAndReturn(run func(context.Context, *model.URL, bool) (string, error)) *Storage_Store_Call {
	_c.Call.Return(run)
	return _c
}

// StoreBatch provides a mock function with given fields: ctx, urls
func (_m *Storage) StoreBatch(ctx context.Context, urls []model.URL) error {
	ret := _m.Called(ctx, urls)
...
func (_c *Storage_StoreBatch_Call) Run(run func(ctx context.Context, urls []model.URL)) *Storage_StoreBatch_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].([]model.URL))
	})
	return _c
...
func (_c *Storage_StoreBatch_Call) RunAndReturn(run func(context.Context, []model.URL) error) *Storage_StoreBatch_Call {
	_c.Call.Return(run)
	return _c
}
